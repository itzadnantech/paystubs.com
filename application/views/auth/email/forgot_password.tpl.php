...
//								$imagesrc = base64_encode(file_get_contents($filepath));
                        ...
                        <tr>
							<td class="content" style="padding: 10px 15px;">
								<h1>Hey There</h1>
								<p>
                                    You recently request to reset your password for your Paystub<br>
									account with following email address. Click the button below to reset it.	
								</p>
								<p> <b style="color:#3D9FC1"> <?php echo $identity;?></b> </p>
                                <a href="<?php echo base_url().'auth/reset_password/'. $forgotten_password_code;?>" target="_blank" style="background:#3D9FC1;color: white;text-decoration: none;font-size: 16px;display: block;max-width: 150px;text-align: center;padding: 8px;border-radius: 5px;margin: 15px auto;">Reset password</a>
                                <p>
                        ...
                        <tr>
                            <td class="content" style="padding: 10px 15px;">
                                <p style="font-size: 12px;">If you're having trouble clicking the password reset button, copy and paste the URL below<br>
                                    into your browser</p>
                                <p style="word-break:break-all;">
								<?php echo base_url().'auth/reset_password/'. $forgotten_password_code; ?>
                                </p>
                            </td>
                        </tr>
                    </table>
