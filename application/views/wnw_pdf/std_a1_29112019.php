<?php 
if($postedData['paystub'] == 'uk__standard__limegreen'){
    //pay slip
    
}
else if($postedData['paystub'] == 'uk__standard__gradientgreen'){
       // color: #7ebc59;
           // background-color: #dfeae6;
}
?>
<?php if($postedData['paystub'] == 'uk__standard__gradientgreen'){ ?>
    <div style="border-top-left-radius:5px;border-top-right-radius:5px;margin-bottom:10px;">
    <table style="width: 100%;border-spacing:0;padding: 0; background-color: #dfeae6;">
            <tr>
                    <td style="padding:10px 10px;font-family: arial;text-align:left;"><span style="color:#7ebc59;"> Company Name : </span><?= $postedData['uk__emloyee__officeaddress'] ?> </td>
