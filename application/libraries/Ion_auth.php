...
class Ion_auth
{
	...
	public function __construct()
	{
		...
		if ($this->config->item('use_ci_email', 'ion_auth') && isset($email_config) && is_array($email_config))
		{
                    ...
                    //     $email_config['useragent'] = "Paystub";
	...
	public function sendEmailMarketingEmail($emailArray){
		$message = "This is message body for Email Marketing!";			
		$fromEmail = $this->config->item('from_email', 'ion_auth');
		$name = $this->config->item('site_title', 'ion_auth');
		$subject = $this->config->item('site_title', 'ion_auth') . ' - Email Marketing';
		if (!empty($emailArray)) {
			$emailArray = array();
			$failedEmail = array();
			...
			$emailArray['successed'] = $successedEmail;
			$emailArray['failed'] = $failedEmail;
			return $emailArray;
		}
	}
